...
right_col.subheader("QQ-plot of {}'s return series ".format(symbol) + "(Jarque bera: p={0:.4f})".format(jb_p_value))
...
with row2_1:
    st.markdown("✅    Return's ACF. vs.\nSquared Return's ACF")
...
if ljbox_test:
    row3_2.write("")
    row3_2.write("")
    ljboxlags = row3_2.slider('Slide me to choose the lags for Ljung–Box test', min_value=5, max_value=50, step = 1, value = 20)
